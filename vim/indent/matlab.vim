" indent file for matlab
" this file is a modified version of the officially distributed `$VIMRUNTIME/indent/matlab.vim`,
" whose origional maintainer is	Christophe Poucet <christophe.poucet@pandora.be>
